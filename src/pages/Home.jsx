...
export default function Home() {
  useSEO({
    title: 'Rc Plane Hub | Premium RC Aircraft & VT-Simple Trainer',
      ...
      <section className="bg-slate-100/70 py-16 border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">Why Beginners Choose Rc Plane Hub</h2>
          </div>
