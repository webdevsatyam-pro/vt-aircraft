...
export default function ContactPage() {
  useSEO({
    title: 'Contact Us | Rc Plane Hub Hangar',
    description: 'Get in touch with the Rc Plane Hub team for sales inquiries, dealer opportunities, and pilot support.'
  });
  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-3">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900">Contact Rc Plane Hub</h1>
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-slate-300">support@rcflightzone.com</span>
              </div>
            </div>
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl border border-gray-200 p-8 shadow-xs">
          ...
          {isSent ? (
            <div className="p-6 bg-emerald-50 border border-emerald-200 rounded-2xl text-center space-y-2">
              ...
              <p className="text-xs text-emerald-700">Thank you for writing to Rc Plane Hub. We will respond within 24 hours.</p>
            </div>
          ) : (
