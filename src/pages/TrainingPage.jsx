...
export default function TrainingPage() {
  useSEO({
    title: 'Flight Academy & Training Manual | VT Aircraft',
    description: 'Master radio control flying step-by-step with the VT Aircraft Flight Academy: pre-flight safety checklists, trimming, pattern flying, and landing procedures.'
  });
