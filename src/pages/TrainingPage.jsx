...
export default function TrainingPage() {
  useSEO({
    title: 'Flight Academy & Training Manual | Rc Flight Zone',
    description: 'Master radio control flying step-by-step with the Rc Flight Zone Flight Academy: pre-flight safety checklists, trimming, pattern flying, and landing procedures.'
  });
