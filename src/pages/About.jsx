...
export default function About() {
  useSEO({
    title: 'About VT Aircraft | Our Engineering Legacy',
    description: 'Learn about VT Aircraft, our aerospace engineering team, and our mission to make RC flight accessible, safe, and enjoyable for everyone.'
  });
  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold text-gray-900">The Story Behind VT Aircraft</h1>
        <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
          Founded by aeronautical engineers and veteran AMA flight instructors, VT Aircraft was created to solve one simple problem: eliminating the fear of crashing for new RC pilots.
        </p>
      </section>
